  ...
  for (let k = 0; k<conceptos.length; k++) {
    ...
    doc.autoTable(columns, listado, {
      ...
      addPageContent: function(data) {
        ...
        //Agregamos al documento encabezado 1;
...
*/
        ...
        doc.setFontType("normal");
        doc.setFontSize(9);
        doc.text("S/."+importe.toString(), 185, 160); 
 ...
 */     
 ...
 //  doc.addImage(imgData, 'JPG', 290, 30, 50, 60);

        /* doc.setFontSize(9);
        doc.setTextColor(25, 57, 107);
        doc.text("Datos de alumno:", 40, 190);
        doc.setFontSize(10);
        doc.text("Alumno : "+ nombres, 40, 210);
        doc.text("Codigo: "+codigo,40,230);
        doc.text("Importe: "+importe,40,250); */
  ...
  render() {
    ...
    return (
      <div>
        ...
        <button  onClick={() => this.demoTwoPageDocument()} className=" waves-effect waves-light btn-large imprimir ">IMPRIMIR-PRUEBA<i className="large material-icons left">local_printshop</i></button>
      </div>
